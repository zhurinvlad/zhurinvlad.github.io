# Vladislav Zhurin Home Page

This is the code for the [Vladislav Zhurin Home Page](https://www.zhurinvlad.com).

![Vladislav Zhurin Home Page Screenshot](/assets/img/screenshots/zhurinvlad-homepage-screenshot.png)
...
Check out [Migrating from Blogger to GitHub Pages and launching the new zhurinvlad.com](https://www.zhurinvlad.com/writing/2015/04/20/migrating-from-blogger-to-github-pages/)
for background info.
...
1. I'm using [UptimeRobot](http://uptimerobot.com/) and
   ...
   metrics.
1. [Favicon](https://www.favicon-generator.org/)
